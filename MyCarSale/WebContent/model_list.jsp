...
<body>
	<div class="container">
		...
		<h1>Model List</h1>
		<a href='model.jsp' class="btn btn-success glyphicon glyphicon-plus"></a>
		<br/><br/>
		<table class="table table-striped">
			...
			<%
			String sql = "SELECT model.id, model.name,brand.name FROM brand,model WHERE brand.id = model.brand_id";
			...
			while(rs.next()){
				...
				out.print("<tr>");
				out.print("<td> "+id+" </td>");
				out.print("<td> "+brandName+" </td>");
				out.print("<td> "+modelName+" </td>");
